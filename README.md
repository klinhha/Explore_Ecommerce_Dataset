...
### 7. Revenue by Device
#### Description: Analyze revenue contribution by device (desktop, mobile, tablet)
#### Result: 
...
#### Description: Identify products frequently purchased together based on customers who bought a specific item
#### Result:
<img width="485" height="568" alt="Image" src="https://github.com/user-attachments/assets/9f6e5a69-950f-4d6c-96a6-7d5403379fc7" />

### 9. Conversion Funnel (View → Add to Cart → Purchase)
#### Description: Build funnel from product view to purchase. Measure drop-off rates
#### Result:
<img width="784" height="109" alt="Image" src="https://github.com/user-attachments/assets/79574d43-f5de-4355-ae64-38ad63b01a35" />

### 10. Revenue Trend & Cumulative Revenue
#### Description: Analyze weekly revenue trend. Calculate cumulative revenue
#### Result:
